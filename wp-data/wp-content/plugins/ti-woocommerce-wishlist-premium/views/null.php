...
?>
<h1><?php esc_html_e( 'Error 404', 'ti-woocommerce-wishlist-premium' ); // WPCS: xss ok. ?></h1>
<h2><?php
	$path = array( @$_type, @$_template_name ); // @codingStandardsIgnoreLine Generic.PHP.NoSilencedErrors.Discouraged
	$path = implode( DIRECTORY_SEPARATOR, $path );
	printf( __( 'Template "%s" not found!', 'ti-woocommerce-wishlist-premium' ), $path ); // WPCS: xss ok.
	?></h2>
