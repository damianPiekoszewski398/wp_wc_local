...
function simple_jwt_login_login_message()
{
    ...
    // FACEBOOK
    if ($jwtSettings->getApplicationsSettings()->isFacebookEnabled() && $jwtSettings->getApplicationsSettings()->isFacebookOauthEnabled()) {
        if (isset($_REQUEST['error'])) {
            $hasError = true;
        }
    }
...
function simple_jwt_login_login_footer()
{
    ...
    switch (true) {
        ...
        // FACEBOOOK
        case $jwtSettings->getApplicationsSettings()->isFacebookEnabled()
            && $jwtSettings->getApplicationsSettings()->isFacebookOauthEnabled()
            && false:
            include_once "views/applications/facebook-form.php";
    }
}
