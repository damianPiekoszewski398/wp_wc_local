...
class RouteService extends BaseService
{
    ...
    const CONFIRM_USER_LINK = 'user/confirm';
    const RESEND_CONFIRM_USER_LINK = 'user/resend_confirm';
    ...
    public function getAllRoutes()
    {
        return [
            ...
            [
                'name' => self::CONFIRM_USER_LINK,
                'method' => self::METHOD_GET,
                'service' => ConfirmEmailService::class
            ],
            [
                'name' => self::RESEND_CONFIRM_USER_LINK,
                'method' => self::METHOD_GET,
                'service' => ResendConfirmEmailService::class
            ],
        ];
    }
