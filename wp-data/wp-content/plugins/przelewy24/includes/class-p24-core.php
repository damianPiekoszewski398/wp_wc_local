...
class P24_Core {
	...
	/**
	 * Class to remind about payments.
	 *
	 * @var P24_Payment_Reminder
	 */
	private $payment_reminder;

	/**
	 * Class to check config.
	 *
	 * @var P24_Config_Checker
	 */
	...
	public function __construct() {
		...
		$this->payment_reminder = new P24_Payment_Reminder( $this );
		$this->config_checker   = new P24_Config_Checker( $this );
	 ...
	 * @throws LogicException If the file is not found.
	 */
	public function render_template_to_string( $template, $params = array() ) {
		ob_start();
		$this->render_template( $template, $params );
		$data = ob_get_clean();
	...
	public function bind_core_events() {
		...
		$this->config_checker->bind_events();
		if ( is_admin() ) {
	 ...
	 */
	public function check_if_from_przelewy24( $order ) {
