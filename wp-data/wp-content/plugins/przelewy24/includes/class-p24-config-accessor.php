...
class P24_Config_Accessor {
	...
	/**
	 * Get p24_send_payment_reminder from config
	 *
	 * @return bool|string
	 */
	public function get_send_payment_reminder() {
		$send_payment_reminder = $this->config->p24_send_payment_reminder;
		return $this->to_selected_bool( $send_payment_reminder );
	}

	/**
	 * Get p24_payment_reminder_delay from config
	 *
	 * @return int
	 */
	public function get_payment_reminder_delay() {
		return (int) $this->config->p24_payment_reminder_delay;
	}
