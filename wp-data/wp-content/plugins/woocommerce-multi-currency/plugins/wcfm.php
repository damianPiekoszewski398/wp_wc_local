...
class WOOMULTI_CURRENCY_Plugin_WCFM {
	...
	public function simple_price_input( $pid ) {
		...
		$regular_price = wc_format_decimal( json_decode( $wc_product->get_meta('_regular_price_wmcp', true ), true ) );
		$sale_price    = wc_format_decimal( json_decode( $wc_product->get_meta('_sale_price_wmcp', true ), true ) );
